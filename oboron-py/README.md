...
- Pros:
  ...
  - *Automatic handling:* Oboron detects the scheme (`ob01`), and can decrypt with its hardcoded key
- Cons:
...
```python
from oboron import Ob31pBase64
ob = Ob31pBase64(key)
ot = ob.enc("hello")
pt2 = ob.dec(ot)
assert pt2 == "hello"
...
ob.set_format("ob21p:b64")
ob.enc("hello")  # now ob21p:b64-encoded obtext
```
...
pt_other = obm.dec(other, "ob01:c32")
```
