...
|--------|----------|----------|----------|----------|
| zfbcx   | 131.5 ns | 125.9 ns | 128.3 ns | 122.3 ns |
| adgs   | 421.8 ns | 434.7 ns | 424.3 ns | 439.7 ns |
| adsv   | 322.7 ns | 366.4 ns | 321.7 ns | 365.9 ns |
| upc  | 150.7 ns | 142.3 ns | 165.1 ns | 140.5 ns |

## `enc()` Performance

| Input Size | legacy     | zfbcx     | adgs     | adsv     | upc    | apgs    | apsv    |
|-----------:|----------|----------|----------|----------|----------|----------|----------|
...
- Probabilistic variants (upc, apgs, apsv) add ~16 bytes overhead for nonce
